...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { description: @machine.description, name: @machine.name, number: @machine.number }
    end
  ...
  test "should update machine" do
    put :update, id: @machine, machine: { description: @machine.description, name: @machine.name, number: @machine.number }
    assert_redirected_to machine_path(assigns(:machine))
  end
